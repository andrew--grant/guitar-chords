...
Guitar.prototype.slide = function (fretNum) {
    // todo: slide up based on chord being palyed
    ...
    //     // make sure all fret numbers visible (due to prev hides)
    //     //$('.fret-number').show(); 
    // }); 
    self.fret2toNGroup.animate({ 'transform': 'translate(-' + (fretWidth * fretNum) + ',0)' }, 3100, mina.elastic);
